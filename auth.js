// auth.js – login page logic: verify password (SHA-256) and redirect to phases.html
...
function goPhases(){ sessionStorage.setItem(AUTH_KEY,'1'); location.replace('phases.html'); }
...
async function handleSubmit(e){
  ...
  if(hash.toLowerCase()===EXPECTED_HASH_HEX.toLowerCase()){ goPhases(); }
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  if(sessionStorage.getItem(AUTH_KEY)==='1'){ goPhases(); }
});
